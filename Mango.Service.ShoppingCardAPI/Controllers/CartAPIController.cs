...
using ProductDto = Mango.Services.ShoppingCartAPI.Models.Dto.ProductDto;
    ...
    public class CartAPIController : ControllerBase
    {
        ...
        public async Task<ResponseDto> GetCart(string userId)
        {
            try
            {
                ...
                IEnumerable<Product> productDtos = (IEnumerable<Product>)await _productService.GetProducts();
